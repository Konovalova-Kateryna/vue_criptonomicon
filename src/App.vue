...
export default {
  ...
  methods: {
    ...
    addTicker() {
      const API_KEY = '82a6fa34b44fcc90cf8f8e2435bd49bc260e0099165a7e8d2ab4409f57de85f2';
      const currentTicker = {
        name: this.ticker,
        price: '-'
      };
      ...
      setInterval(async() => {
        const f = await fetch(`https://min-api.cryptocompare.com/data/price?fsym=${currentTicker.name}&tsyms=USD&${API_KEY}`)
